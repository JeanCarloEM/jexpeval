...
export declare abstract class baseProcessor implements D.TTypesProcessor {
    ...
    abstract eval(input: string | unknowParser.Expression): Promise<D.TEvalResult>;
    static genericCallerSolver(name: string, args: any[]): Promise<D.TEvalResult>;
    static genericValuesSolver(name: string): Promise<D.TEvalResult>;
