...
var jexpeval = (function (_super) {
    ...
    jexpeval.runAsWorker = function (str, printable, _parser, _workerCreator, _caller, _values) {
        ...
        if (_caller === void 0) { _caller = _baseProcessor__WEBPACK_IMPORTED_MODULE_0__.baseProcessor.genericCallerSolver; }
        if (_values === void 0) { _values = _baseProcessor__WEBPACK_IMPORTED_MODULE_0__.baseProcessor.genericValuesSolver; }
        if (!window) {
